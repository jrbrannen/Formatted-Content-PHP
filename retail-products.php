<?php
    ...
    // Unit 8 Fomatting Content Assignment
    // WDV341 Jeremy Brannen
...
<html>
    ...
    <body>
        ...
        <section>
            ...
            <!-- php foreach loop uses fetchAll to retrieve each row from the db and store each row as a $result object -->
            <?php 
            ...
            ?>
                <div class="productBlock">
                    ...
                    <?php
                        ...
                        ?>
                            <p class="productLowInventory"><?php echo $result['product_inStock']; ?> In Stock!</p>
                        <?php
                        }
                    ?>
                    <?php    
        ...
        <footer>
            ...
            <p class="text-center">
                <a target="_blank"href="https://github.com/jrbrannen/Formatted-Content-PHP.git">GitHub Repo Link</a>    <!--  GitHub Repo Link -->
            </p>
